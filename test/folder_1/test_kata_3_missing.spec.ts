...
describe('Missing mutation coverage for 3_kata', () => {
    it('should verify Zergling.closeUnits is initialized as an empty array and not mutated unexpectedly', () => {
    ...
    it('should test Zealot.alive always returns true even when hitpoints are 0 or less', () => {
        const zealot = new Zealot();
        zealot.hurt(2);
